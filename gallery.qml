        ...
        Flickable {
            ...
            Column {
                ...
                Text {
                    ...
                    color: Tokens.ink; font.pixelSize: 22; font.bold: true
                }

                // ---- contrast audit (theming §8) ----
                Column {
                    spacing: 4
                    Text { text: "Contrast audit"; color: Tokens.inkDim; font.pixelSize: 13 }
                    Repeater {
                        model: [
                            ["ink/surface",    Tokens.cOnSurface,    4.5],
                            ["inkDim/surface", Tokens.cOnSurfaceDim, 4.5],
                            ["inkOnAccent/accent",      Tokens.cOnAccent,     4.5],
                            ["critical/surface",     Tokens.cCritical,     3.0]
                        ]
                        delegate: Row {
                            required property var modelData
                            spacing: 10
                            Text { width: 190; text: modelData[0]
                                   color: Tokens.inkDim; font.pixelSize: 12; font.family: "monospace" }
                            Text { text: modelData[1].toFixed(2) + ":1"
                                   font.pixelSize: 12; font.family: "monospace"
                                   color: modelData[1] >= modelData[2] ? Tokens.success : Tokens.critical }
                            Text { text: modelData[1] >= modelData[2] ? "ok" : ("FAILS min " + modelData[2])
                                   font.pixelSize: 12
                                   color: modelData[1] >= modelData[2] ? Tokens.inkDim : Tokens.critical }
                        }
                    }
                }

                // ---- stateful icons across their range ----
                Text { text: "Stateful — the four that encode a value"; color: Tokens.inkDim; font.pixelSize: 13 }
                ...
                Row {
                    ...
                    Repeater {
                        ...
                        delegate: Column {
                            ...
                            Text { text: Math.round(modelData*100) + "%"; color: Tokens.inkDim; font.pixelSize: 10 }
                        }
                    }
                    Column {
                        spacing: 4
                        Volume { muted: true }
                        Text { text: "mute"; color: Tokens.inkDim; font.pixelSize: 10 }
                    }
                }
                ...
                Row {
                    ...
                    Repeater {
                        ...
                        delegate: Column {
                            ...
                            Text { text: modelData.s; color: Tokens.inkDim; font.pixelSize: 10 }
                        }
                    }
                }
                ...
                Row {
                    ...
                    Repeater {
                        ...
                        delegate: Column {
                            ...
                            Text { text: modelData + " bars"; color: Tokens.inkDim; font.pixelSize: 10 }
                        }
                    }
                    Column {
                        spacing: 4
                        Wifi { connected: false }
                        Text { text: "offline"; color: Tokens.inkDim; font.pixelSize: 10 }
                    }
                }

                // ---- static set ----
                Text { text: "Static — imported geometry via PathSvg"; color: Tokens.inkDim; font.pixelSize: 13 }
                Flow {
                    width: parent.width
                    spacing: 18
                    Repeater {
                        ...
                        delegate: Column {
                            ...
                            Text { text: modelData[0]; color: Tokens.inkDim; font.pixelSize: 10 }
                        }
                    }
                }

                // ---- three sizes: the crispness check at real scale (icons §7) ----
                Text { text: "Sizes — check crispness at the panel's real scale factor"; color: Tokens.inkDim; font.pixelSize: 13 }
                Row {
                    spacing: 24
                    Repeater {
                        model: [16, 24, 48]
